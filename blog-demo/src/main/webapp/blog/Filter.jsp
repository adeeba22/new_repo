...
<%@ page import="com.upgrad.blog.dao.PostDAO" %>
...
<header class="header">
    ...
    <%  if(null!=session.getAttribute("emailId"))
    {
        out.print("Logged in as "+session.getAttribute("emailId").toString().split("@")[0]);
    }
    %>

</header>
<div id="form_wrapper">
    <form id="filter_form" method="post" action="/blog/post">
        <div id="tag_div">
            ...
            -->
                <%
                    HashSet<String> tagList = ((PostDAO)DAOFactory.postsCRUD()).findAllTags();
...
-->
    <%
    if(null!=request.getAttribute("dao")){
        List<PostDTO> dao = (List<PostDTO>)request.getAttribute("dao");

        for(PostDTO l :dao){

            out.println(l.getEmailId()+"<br/>");
            out.println(l.getDescription()+"<br/>");
            out.println(l.getPostId()+"<br/>");
            out.println(l.getTag()+"<br/>");
            out.println(l.getTitle()+"<br/>");
            out.println(l.getTimestamp());
            out.println("<br/>");
        }
    }
    %>
