...
<%
    ...
    */
    ...
    if(null!=request.getAttribute("dtoObj")){
        PostDTO dto = (PostDTO) request.getAttribute("dtoObj");
        out.println("Email Id:"+dto.getEmailId()+"<br/>");
        out.println("Title:"+dto.getTitle()+"<br/>");
        out.println("Tag:"+dto.getTag()+"<br/>");
        out.println("Description:"+dto.getDescription()+"<br/>");
        out.println("Time:"+dto.getTimestamp());
