...
create table posts (id number primarTRG_POST_IDy key, email_id varchar2(100), title varchar2(200), description varchar2(1000), tag varchar2(10), timestamp varchar2(200));
